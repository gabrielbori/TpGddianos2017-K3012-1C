...
namespace UberFrba.CapaDAO
{
    public class SqlConnector
    {
        ...
        public static void conexionSql(SqlConnection cn, SqlCommand cm)
        {
            try
            {
                string sconcompleto = UberFrba.Model.Globals.getConnectionString();
        ...
        private static void _executeProcedure(string procedure, List<string> args, params object[] values)
        {
            ...
            try
            {
                ...
                cm.CommandText = "GDDIANOS." + procedure;
        ...
        private static List<string> _generateArguments(string procedure)
        {
            ...
            try
            {
                ...
                cm.CommandText = "SELECT PARAMETER_NAME FROM information_schema.parameters WHERE SPECIFIC_SCHEMA='GDDIANOS' AND SPECIFIC_NAME='" + procedure + "'";
                dr = cm.ExecuteReader();
                dt.Load(dr);
