...
CREATE SEQUENCE GDDIANOS.PAGO_NUMERO AS INT START WITH 46409 INCREMENT BY 1;
/**********/
/* TABLAS */
/**********/
...
GO
CREATE PROCEDURE GDDIANOS.VIAJE_YA_REGISTRADO (@FECHA DATETIME ,@HORAI DATETIME, @HORAF DATETIME, @CLIENTE INT) AS
