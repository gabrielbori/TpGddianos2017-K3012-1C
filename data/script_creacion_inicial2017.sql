...
BEGIN
	...
	SELECT @ID_PERSONA = FACT_PERS_ID FROM INSERTED;
	SELECT @TIPO_PERSONA = PERS_TIPO FROM GDDIANOS.PERSONA WHERE PERS_ID=@ID_PERSONA
	IF(@TIPO_PERSONA=1 OR @TIPO_PERSONA=3) 
	BEGIN 
	 
		INSERT INTO GDDIANOS.FACTURA ([FACT_NRO]
      ,[FACT_FECHA_GENERADA]
      ,[FACT_FECHA_INICIO]
      ,[FACT_FECHA_FIN]
      ,[FACT_IMPORTE_TOTAL]
