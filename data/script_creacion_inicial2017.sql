...
RETURN (
	...
	FROM FUNCIONALIDAD JOIN FUNCIONALIDAD_POR_ROL ON (FUNCIONALIDAD_ID = FUNC_ID)
	JOIN ROL ON (FUNC_ROL_ID = ROL_ID)
	WHERE ROL_ID = @ID)
END

GO
INSERT INTO GDDIANOS.PERSONA VALUES (1, 46415743, 'Alex', 'Falcon', 38457835, 'Cosquin 295', 25/10/1994,1,'alex.falcon.25@hotmail.com');
INSERT INTO GDDIANOS.USUARIO VALUES ('afalcon', CONVERT(VARBINARY(32),'e6b87050bfcb8143fcb8db0170a4dc9ed00d904ddd3e2a4ad1b1e8dc0fdc9be7',2),0,1,1);
...
INSERT INTO GDDIANOS.USUARIO VALUES ('rfalcon', CONVERT(VARBINARY(32),'e6b87050bfcb8143fcb8db0170a4dc9ed00d904ddd3e2a4ad1b1e8dc0fdc9be7',2),0,1,2);
...
INSERT INTO GDDIANOS.USUARIO VALUES ('jfalcon', CONVERT(VARBINARY(32),'e6b87050bfcb8143fcb8db0170a4dc9ed00d904ddd3e2a4ad1b1e8dc0fdc9be7',2),0,1,3);

INSERT INTO GDDIANOS.PERSONA VALUES (4, 123455, 'ADMIN', 'ADMIN', 38457835, 'UBERFRBA', 25/10/1994,1,'');
INSERT INTO GDDIANOS.USUARIO VALUES ('ADMIN', CONVERT(VARBINARY(32),'e6b87050bfcb8143fcb8db0170a4dc9ed00d904ddd3e2a4ad1b1e8dc0fdc9be7',2),0,1,4);
...
VALUES(1,'abmAutomovilToolStripMenuItem');

INSERT INTO GDDIANOS.FUNCIONALIDAD
(FUNCIONALIDAD_ID,DESCRIPCION)
VALUES(2,'abmChoferToolStripMenuItem');

INSERT INTO GDDIANOS.FUNCIONALIDAD
(FUNCIONALIDAD_ID,DESCRIPCION)
VALUES(3,'abmClienteToolStripMenuItem');

INSERT INTO GDDIANOS.FUNCIONALIDAD
(FUNCIONALIDAD_ID,DESCRIPCION)
VALUES(4,'facturacionToolStripMenuItem');

INSERT INTO GDDIANOS.FUNCIONALIDAD
(FUNCIONALIDAD_ID,DESCRIPCION)
VALUES(5,'listadoEstadisticoToolStripMenuItem');

INSERT INTO GDDIANOS.FUNCIONALIDAD
(FUNCIONALIDAD_ID,DESCRIPCION)
VALUES(6,'registroDeViajesToolStripMenuItem');

INSERT INTO GDDIANOS.FUNCIONALIDAD
(FUNCIONALIDAD_ID,DESCRIPCION)
VALUES(7,'rendicionDeViajesToolStripMenuItem');

INSERT INTO GDDIANOS.FUNCIONALIDAD
(FUNCIONALIDAD_ID,DESCRIPCION)
VALUES(8,'rolToolStripMenuItem');

INSERT INTO GDDIANOS.FUNCIONALIDAD
(FUNCIONALIDAD_ID,DESCRIPCION)
VALUES(9,'cerrarSesiònToolStripMenuItem');

INSERT INTO GDDIANOS.FUNCIONALIDAD
(FUNCIONALIDAD_ID,DESCRIPCION)
VALUES(10,'salirToolStripMenuItem');

INSERT INTO GDDIANOS.FUNCIONALIDAD_POR_ROL (FUNC_ROL_ID,FUNC_ID) VALUES(1,1);
