...
BEGIN
	SELECT VIAJE_FECHA Fecha, TURNO_PRECIO_BASE 'Precio base',
...
;
 	 ...
 	 --PUSE QUE LOS VIAJES DUREN UNA HORA
 INSERT INTO GDDIANOS.VIAJE 
  ...
  SELECT DISTINCT 1,CONVERT(DATE,[VIAJE_FECHA],121),CONVERT(TIME,[VIAJE_FECHA],121),DATEADD (HOUR , 1,CONVERT (TIME, [VIAJE_FECHA],121)),[Viaje_Cant_Kilometros] ,GDDIANOS.GETIDPERSONAPORDNI([CHOFER_DNI]),GDDIANOS.GETIDPERSONAPORDNI([CLIENTE_DNI])  
